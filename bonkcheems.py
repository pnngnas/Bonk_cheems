...
point = 0
#LOAD FONT
font = pygame.font.Font("./asset/font.ttf", 32)
font2 = pygame.font.Font("./asset/font.ttf", 60)
...
#LOAD IMAGE
dog = pygame.image.load("./asset/dog.png")
dog_rect = dog.get_rect()
dog_rect.center = (WINDOW_WIDTH/2,WINDOW_HEIGHT/2)
#Load Sound
bonk_sound = pygame.mixer.Sound("./asset/bonk.mp3")
miss_sound = pygame.mixer.Sound("./asset/miss.mp3")
game_over_sound = pygame.mixer.Sound("./asset/gameover.wav")
